...
open class GroupOperation: Operation {
    ...
    open func operationDidFinish(_: Foundation.Operation, withErrors _: [NSError]) {
        // For use by subclassers.
    }
}

extension GroupOperation: OperationQueueDelegate {
    public final func operationQueue(_: OperationQueue, willAddOperation operation: Foundation.Operation) {
    ...
    public final func operationQueue(_: OperationQueue, operationDidFinish operation: Foundation.Operation, withErrors errors: [NSError]) {
