...
public protocol OperationQueueDelegate: NSObjectProtocol {
    ...
    func operationQueue(_ operationQueue: OperationQueue, operationDidFinish operation: Foundation.Operation, withErrors errors: [NSError])
}
...
open class OperationQueue: Foundation.OperationQueue {
    ...
    open override func addOperations(_ ops: [Foundation.Operation], waitUntilFinished wait: Bool) {
        /*
