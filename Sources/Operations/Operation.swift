...
open class Operation: Foundation.Operation {
    ...
    static func keyPathsForValuesAffectedByState() -> [String] {
        ["isReady", "isExecuting", "isFinished"]
    }

    static func keyPathsForValuesAffectedByCancelledState() -> [String] {
        ["isReady", "isCancelled"]
    }
    ...
    fileprivate var state: State {
        ...
        set(newState) {
            ...
            for keyPath in Self.keyPathsForValuesAffectedByState() {
            ...
            for keyPath in Self.keyPathsForValuesAffectedByState().reversed() {
    ...
    var _cancelled = false {
        willSet {
            ...
            for keyPath in Self.keyPathsForValuesAffectedByCancelledState() {
                willChangeValue(forKey: keyPath)
            }
        }

        didSet {
            for keyPath in Self.keyPathsForValuesAffectedByCancelledState().reversed() {
                didChangeValue(forKey: keyPath)
            }
